[![Build Status](https://github.com/stroppycow/JFastText/actions/workflows/cicd.yaml/badge.svg
)](https://github.com/stroppycow/JFastText/actions)
...
```bash
git clone --recursive https://github.com/stroppycow/JFastText
cd JFastText
git submodule init
